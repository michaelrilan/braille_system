...
urlpatterns = [
    ...
    path("notif_braille/<shared_id>", views.notif_braille, name="notif_braille"),
    path("notif_braille_admin/<braille_id>", views.notif_braille_admin, name="notif_braille_admin"),
